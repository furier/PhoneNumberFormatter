...
namespace PhoneNumberFormatter.Tests
{
    ...
    public class PhoneNumberFormatterTests
    {
        ...
        {
            ParameterizedPhoneNumberFormatterTest("33369999", "", "333 69 999");
        }

        [TestMethod]
        public void PhoneNumberFormatterTest_OneSpaceInNumber1()
        {
            ParameterizedPhoneNumberFormatterTest("3 3369999", "", "333 69 999");
        }

        [TestMethod]
        public void PhoneNumberFormatterTest_OneSpaceInNumber2()
        {
            ParameterizedPhoneNumberFormatterTest("33 369999", "", "333 69 999");
        }

        [TestMethod]
        public void PhoneNumberFormatterTest_OneSpaceInNumber3()
        {
            ParameterizedPhoneNumberFormatterTest("333 69999", "", "333 69 999");
        }

        [TestMethod]
        public void PhoneNumberFormatterTest_OneSpaceInNumber4()
        {
            ParameterizedPhoneNumberFormatterTest("3336 9999", "", "333 69 999");
        }

        [TestMethod]
        public void PhoneNumberFormatterTest_OneSpaceInNumber5()
        {
            ParameterizedPhoneNumberFormatterTest("33369 999", "", "333 69 999");
        }

        [TestMethod]
        public void PhoneNumberFormatterTest_OneSpaceInNumber6()
        {
            ParameterizedPhoneNumberFormatterTest("333699 99", "", "333 69 999");
        }

        [TestMethod]
        public void PhoneNumberFormatterTest_OneSpaceInNumber7()
        {
            ParameterizedPhoneNumberFormatterTest("3336999 9", "", "333 69 999");
        }

        [TestMethod]
        public void PhoneNumberFormatterTest_SpacesBetweenEveryNumber()
        {
            ParameterizedPhoneNumberFormatterTest("3 3 3 6 9 9 9 9", "", "333 69 999");
        }

        [TestMethod]
        public void PhoneNumberFormatterTest_MultipleSpacesInNumber()
        {
            ParameterizedPhoneNumberFormatterTest("3  3 3    699   99", "", "333 69 999");
        }
        ...
        private static async void ParameterizedPhoneNumberFormatterTest(string phoneNumberInput, string countryInput, string phoneNumberExpectedResult)
        {
            var result = await PhoneNumberFormatter.FormatAsync(phoneNumberInput, countryInput);
